...
import { S1_SurvivalByAge, S2_SurvivalLatency, S3_SelfProbeE2E, S4_ClientDiversity, S5_MultiSourceBreadth, S6_KzgIntegrity } from "./_panels/safety";
import { L1_BlobsPerSlot, L2_FinalityLag, L3_BlobBasefee, L4_InclusionLatency } from "./_panels/liveness";
import { C1_CasperReadout, C2_SidecarPropagation, C3_GossipArrival, C4_ReorgTimeline } from "./_panels/cross";
